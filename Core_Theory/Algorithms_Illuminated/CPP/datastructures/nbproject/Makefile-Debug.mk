...
${OBJECTDIR}/pqueue.o: pqueue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pqueue.o pqueue.cpp

${OBJECTDIR}/pqueue.o: pqueue.tpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pqueue.o pqueue.tpp
...
${TESTDIR}/tests/pqueue_Test.o: tests/pqueue_Test.c++ 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pqueue_Test.o tests/pqueue_Test.c++
...
${OBJECTDIR}/pqueue_nomain.o: ${OBJECTDIR}/pqueue.o pqueue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pqueue_nomain.o pqueue.cpp;\
	else  \
...
${OBJECTDIR}/pqueue_nomain.o: ${OBJECTDIR}/pqueue.o pqueue.tpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pqueue_nomain.o pqueue.tpp;\
	else  \
	    ${CP} ${OBJECTDIR}/pqueue.o ${OBJECTDIR}/pqueue_nomain.o;\
	fi
