...
${OBJECTDIR}/booleanFormula.o: booleanFormula.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../Graph -include ../Graph/PrimEdge.h -include ../Graph/PrimNode.h -include ../Graph/UndirectedWeightedGraph.h -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/booleanFormula.o booleanFormula.cpp

${OBJECTDIR}/clause.o: clause.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../Graph -include ../Graph/PrimEdge.h -include ../Graph/PrimNode.h -include ../Graph/UndirectedWeightedGraph.h -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clause.o clause.cpp
...
${OBJECTDIR}/booleanFormula_nomain.o: ${OBJECTDIR}/booleanFormula.o booleanFormula.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../Graph -include ../Graph/PrimEdge.h -include ../Graph/PrimNode.h -include ../Graph/UndirectedWeightedGraph.h -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/booleanFormula_nomain.o booleanFormula.cpp;\
	else  \
...
${OBJECTDIR}/clause_nomain.o: ${OBJECTDIR}/clause.o clause.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../Graph -include ../Graph/PrimEdge.h -include ../Graph/PrimNode.h -include ../Graph/UndirectedWeightedGraph.h -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clause_nomain.o clause.cpp;\
	else  \
