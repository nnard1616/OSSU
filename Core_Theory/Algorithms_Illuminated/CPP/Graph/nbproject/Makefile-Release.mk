...
${OBJECTDIR}/DirectedWeightedGraph.o: DirectedWeightedGraph.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DirectedWeightedGraph.o DirectedWeightedGraph.cpp

${OBJECTDIR}/Edge.o: Edge.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Edge.o Edge.cpp
...
${OBJECTDIR}/WeightedNode.o: WeightedNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WeightedNode.o WeightedNode.cpp
