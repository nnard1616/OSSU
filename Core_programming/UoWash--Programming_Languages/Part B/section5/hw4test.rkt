...
(define tests
  (test-suite
   ...
   (check-equal? (list-nth-mod (list 5 2 4    ) 11) 4 "list-nth-mod test")
   ...
   ; vector-assoc test
   (check-equal? (vector-assoc 4 (vector (cons 2 1) "a" (cons 3 1) (cons 4 1) (cons 5 1))) (cons 4 1) "vector-assoc test")
